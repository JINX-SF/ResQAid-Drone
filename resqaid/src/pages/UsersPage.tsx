          ...
          {users.map((u, i) => (
            ...
            >
              ...
              <div className="text-sm">
                <div className="underline underline-offset-2 text-foreground/90">{u.email}</div>
                <div className="text-xs text-muted-foreground">{u.phone}</div>
              </div>
              <div className="text-foreground/80">{u.joined}</div>
              <div className="text-foreground/80">{u.location}</div>
